...
namespace Sarafi.DataAccess.Migrations
{
    ...
    [Migration("20220601054842_Addinglocationidcolumnintoaspnetusertable")]
    partial class Addinglocationidcolumnintoaspnetusertable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sarafi.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<byte?>("ZLocationLocationId")
                        .HasColumnType("tinyint");

                    b.HasIndex("ZLocationLocationId");
            ...
            modelBuilder.Entity("Sarafi.Models.ApplicationUser", b =>
                {
                    b.HasOne("Sarafi.Models.DB.ZLocation", "ZLocation")
                        .WithMany("ApplicationUsers")
                        .HasForeignKey("ZLocationLocationId");

                    b.Navigation("ZLocation");
                });
